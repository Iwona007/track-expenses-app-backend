...
class FinancialTransactionController {
    ...
    ResponseEntity<List<FinancialTransactionDTO>> getFinancialTransactionsByWalletId(@RequestParam @Min(1) @NotNull Long walletId) {
        ...
        return new ResponseEntity<>(financialTransactionDTOList, OK);
    }
    ...
    public ResponseEntity<FinancialTransactionDTO> createFinancialTransaction(
        ...
        FinancialTransactionDTO financialTransactionDTO = financialTransactionService
                .createFinancialTransaction(createFinancialTransactionDTO);
        return new ResponseEntity<>(financialTransactionDTO, CREATED);
    }
    ...
    public ResponseEntity<FinancialTransactionDTO> findTransactionById(@Min(1) @NotNull @PathVariable Long id) {
        ...
        return new ResponseEntity<>(financialTransaction, OK);
    ...
    public ResponseEntity<FinancialTransactionDTO> updateTransactionById(
        ...
        return new ResponseEntity<>(financialTransactionDTO, OK);
    }
}
